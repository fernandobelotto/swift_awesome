...
## Analytics
*Analytics related libraries to easily track your app usage* 
...
## CSV
*Helpful libraries to parse from and serialize to comma-separated value representations.* 
...
## Multi Database
*Data management layers that involve multiple sources.* 
...
## Embedded Systems
*Build your embedded Linux projects on a RaspberryPi, BeagleBone, C.H.I.P. and other boards.* 
...
### Barcode
*Barcode, QR-code, other code readers* 
...
## Haptic Feedback
*Libraries that involve the use of Haptic Feedback* 
...
## Key Value Coding
*Libraries for key-value coding* 
...
## Cryptography
*Deal with cryptography method easily* 
